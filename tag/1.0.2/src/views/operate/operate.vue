		...
		<el-table :data="datas" highlight-current-row v-loading="listLoading" style="width: 100%;">
		  ...
		  <el-table-column label="操作" width="250">
		     <template scope="scope">
                ...
                <el-button size="small" v-if="scope.$index==0" >置顶</el-button>
...
export default {
    ...
    methods: {
         ...
         handleDel: function(row) {
                ...
                let result = await api.deleteBanner(row.banner_id);
                if (result == 1) {
        ...
        //显示编辑界面
           ...
           handletop: function (index,id) {
               ...
               this.$confirm('确认置顶吗?', '提示', {
                        ...
                        let result=await api.setbannertop(id);
                        this.listLoading = false;
                        this.getlunbo();
                    }).catch(() => {
        ...
        async addSubmit() {
               this.$refs.editForm.validate(async (valid) => {
                    ...
                    this.$confirm('确认提交吗？', '提示', {}).then(async () => {
                        ...
                        await api.addbanner(para)
                    }else{
                        let para = Object.assign({}, this.editForm);
                        await api.updatebanner(para)
                    }
        ...
        async getlunbo() {
            ...
            let paras = {  };
            let list=await api.getbanner(paras);
            this.datas=list;
         },
        //恢复编辑页面为默认
        clearEdit(){
