...
:row-class-name="tableRowClassName"
       ref="multipleTable" :data="datas" highlight-current-row v-loading="listLoading" @selection-change="selsChange" @sort-change="sortChang" style="width: 100%;">
            ...
            <el-table-column prop="jurisdiction" label="权限" min-width="100" align="center"></el-table-column>
        ...
        <el-dialog  :title=dialogTitle  :visible.sync="dialogVisible" :close-on-click-modal="false" @close="handleClose">
            <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="套系权限：" prop="jurisdiction">
                    <el-select v-model="editForm.jurisdiction" clearable placeholder="请选择套系权限">
                        <el-option v-for="items in optionsDJ" :key="items.jurisdiction" :label="items.jurisdiction" :value="items.jurisdiction"></el-option>
                    </el-select>
                </el-form-item>
