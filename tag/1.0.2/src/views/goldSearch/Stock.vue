<template>
        <el-form-item :label='title'>
           <Stockname :stockObj=stockNameCode :v-on:stock-say="listenStock"></Stockname>
            ...
            入选简介<el-input v-model="stockObj.jianjie" auto-complete="off" placeholder="20个字以内" ></el-input>
            投资亮点<UeEdit :thisData="'reason'" v-on:ueIpt-say="listenThisUe" :maxWords=200  :defaultMsg='stockObj["reason"]' :ref=nowRef></UeEdit>
            技术分析<UeEdit :thisData="'analysis'" v-on:ueIpt-say="listenThisUe" :maxWords=200  :defaultMsg='stockObj["analysis"]' :ref=nowRef></UeEdit>
        </el-form-item>
    </template>
