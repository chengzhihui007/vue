...
<script>
    import {goldSearchList,goldSearchsave,goldSearchupdate,goldSearchdelect,goldSearchupdateview} from "../../api/cyApi.js";
        ...
        methods: {
            ...
            handleCurrentChange(val) {
                ...
                var para = {
                    pageNo:this.page,
                    pageSize:this.pageSize,
                    orderBy:"a.goldResearch_id DESC "
                };
                this.findAll(para);
            },
            alertMessage(msg) {
            ...
            handleEdit: function(index, row) {
                ...
                row.banKuai= JSON.parse(row.stock)
            ...
            async zhushuiSubmit() {
                this.$refs.zhushuiObj.validate(async (valid) => {
                    ...
                    if (valid) {
                        goldSearchupdateview(this.sels).then(res => {
                            this.$message({
                                message: "注水成功",
                                type: "success"
                            });
            ...
            async handleDel(index, row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    console.log(row)
                    var paradel = {
                        goldResearch_id:row.goldResearch_id
                    };
                    ...
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(async() => {
                            ...
                            if (this.editOrAdd) {
                                ...
                                para.update_time=String( new Date().getTime());
                                result =goldSearchupdate(para).then(res => {
                                    this.$message({
                                        message: '提交成功',
                                        type: 'success'
                                    });
