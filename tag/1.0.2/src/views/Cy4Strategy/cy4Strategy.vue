        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="条件设置" disabled name="second">
                <div class="wrapper">
                    ...
                    <div class="head">选股条件:
                        <el-button type="primary" :loading="loading,loading1,loading2" @click="goImplementation()">立即执行</el-button>
                    </div>
                    <div class="xuandiv">
                        <el-form :model="xuanguForm">
                            <el-form-item >
                    ...
                    <el-tabs v-model="activeName2" type="card" @tab-click="handleClick1">
                        <el-tab-pane label="明星分析师推荐" name="first" >
                            <el-table :data="addList" style="width: 120%">
                                ...
                                <el-table-column prop="secCode" label="股票代码" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.secCode }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="industryAttention" label="行业关注度" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.industryAttention }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="stockConcern" label="个股关注度" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.stockConcern }}</div>
                                    </template>
                                </el-table-column>
                                <!-- <el-table-column prop="buyRating" label="买入评级" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.buyRating }}</div>
                                    </template>
                                </el-table-column> -->
                                <el-table-column prop="watchTime" label="看多评级" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.watchTime }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="starAnalysts" label="明星分析师推荐" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.starAnalysts }}</div>
                                    </template>
                                </el-table-column>
                            </el-table>
                        ...
                        <el-tab-pane label="明星机构推荐" name="second" >
                            <el-table :data="jigouList" style="width: 120%">
                                <el-table-column prop="date" label="序号" width="180">
                                    <template scope="num">
                                        {{num.$index+1}}
                                    </template>
                                ...
                                <el-table-column prop="holdRating" label="增持评级" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.holdRating }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="starAgency" label="明星机构推荐" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.starAgency }}</div>
                                    </template>
                                </el-table-column>
                            </el-table>
                            <el-pagination @current-change="handleCurrentChange1" :current-page="currentPage" :page-size=this.size1 layout="total, prev, pager, next, jumper" :total=this.total1></el-pagination>
                        </el-tab-pane>
                        <el-tab-pane label="涨幅空间最大" name="third" >
                            <el-table :data="zhangfuList" style="width: 120%">
                                <el-table-column prop="date" label="序号" width="180">
                                    <template scope="num">
                                        {{num.$index+1}}
                                    </template>
                                </el-table-column>
                                <el-table-column prop="dates" label="日期" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{scope.row.dates.substring(0,10)}}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="title" label="标题" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.title }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="secName" label="相关股票" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.secName }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="publishingAgency" label="发布机构" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.publishingAgency }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="researcher" label="研究员" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.researcher }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="grade" label="评级" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.grade }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="targetPrice" label="目标价（元）" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{scope.row.targetPriceDown}}——{{ scope.row.targetPrice }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="releaseDateClosePrice" label="发布日收盘价" width="180">
                                    <template scope="scope">
                                        <div class="deleted-text">{{ scope.row.releaseDateClosePrice }}</div>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="targeIncrease" label="目标涨幅" width="180">
                                    <template scope="scope">
                                        <div v-if="scope.row.targeIncrease==null">
                                            <div class="deleted-text">{{ scope.row.targeIncrease }}</div>
                                        </div>
                                        <div v-else>
                                            <div class="deleted-text">{{ scope.row.targeIncrease }}%</div>
                                        </div>
                            ...
                            <el-pagination @current-change="handleCurrentChange2" :current-page="currentPage" :page-size=this.size2 layout="total, prev, pager, next, jumper" :total=this.total2></el-pagination>
                        </el-tab-pane>
                    </el-tabs>
                    

                    <div class="head">今日操作日志:
                        <el-button type="primary" @click="$router.push('/rdztybcl/quanburizhi')">查看全部日志</el-button>
                    </div>
...
export default {
    ...
    methods:{
        ...
        handleClick1(tab, event) {
            ...
            if(tab.name=='first'){
                this.getMinXingFenXiShiResult();
            }
            if(tab.name=='second'){
                this.getMinXingJiGouResult();
            }
            if(tab.name=='third'){
                this.getZhangFuKongJianResult();
            }
        },
        handleCurrentChange(val) {
            ...
            if(this.aa=='0'){//筛选前页码跳转
                ...
                this.getMinXingFenXiShiResult(para);
            }else{//筛选后页码跳转
                let page=this.page2
                let size=this.size2
        ...
        getStrategy(){
            let result = {}
            this.strategy_flag = 1
            result= api.getStrategy(this.strategy_flag).then((res)=>{
      ...
      goXuanGu(){
          for(var i=0;i<this.banknameList.length;i++){
                let stockSel = {}
                // this.banknameList[i].moudle_flag = '1'
                // this.banknameList[i].selection_condition = this.banknameList[i].name
                // stockSel.moudle_flag='1'
          ...
          this.$router.push({path:'/rdztybcl/xuangufanwei',query:{banknameList:this.stockList}})
        //   $router.push({path:'/rdztybcl/xuangufanwei',query:{banknameList:this.banknameList}})
      },
      goJiBenMian(){
          ...
          this.$router.push({path:'/rdztybcl/jibenmianxuangu',query:{seleData:this.stockList}})
      },
      goTeSeZhiBiao(){
          ...
          this.$router.push({path:'/rdztybcl/tesezhibiaoxuanxu',query:{teseList:this.stockList}})
      },
      //今日操作日志
      todayLog(){
           let result = {}
        ...
        getMinXingFenXiShiResult(){
            ...
            if(this.activeName2 == 'first'){
                // let path = "/ydhxgtest/SelectCondition/mingxingfenxishi/"
                ...
                //         api.getMingXingFenXiShi(page,size,satisfaction_mode_jbm,contain_ST_jbm,satisfaction_mode_tszb,contain_ST_tszb,zhixingList).then((res)=>{
                ...
                if(this.statu==0){
                    ...
                    // this.sign = '0'
                    var iden = '0'//查全部
                    api.getMingXingFenXiShi(page,size,satisfaction_mode_jbm,contain_ST_jbm,satisfaction_mode_tszb,contain_ST_tszb,iden,zhixingList).then((res)=>{
                        this.addList = res.data.content
                        this.total = res.data.totalElements
                    });
                }else{
        ...
        getMinXingJiGouResult(){
            ...
            if(this.activeName2 == 'second'){
                // let path = "/ydhxgtest/SelectCondition/mingxingjigou/"
                // ydc.sync().ref(path).orderByKey().get(d=>{
                //     if(d.success){
                //         zhixingList = d.nodeContent.list.replace(/\'/g, "");
                //         page1 = this.page1;
                ...
                //         contain_ST_tszb = d.nodeContent.contain_ST_tszb;
                //         // alert(zhixingList)
                //         api.getMinXingJiGouResult(page1,size1,satisfaction_mode_jbm,contain_ST_jbm,satisfaction_mode_tszb,contain_ST_tszb,zhixingList).then((res)=>{
                //             this.jigouList = res.data.content
                ...
                if(this.statu==0){
                    ...
                    // this.sign = '0'
                    var iden = '0'//查全部
                    api.getMinXingJiGouResult(page1,size1,satisfaction_mode_jbm,contain_ST_jbm,satisfaction_mode_tszb,contain_ST_tszb,iden,zhixingList).then((res)=>{
                        this.jigouList = res.data.content
                        this.total1 = res.data.totalElements
                    });
                }else{
        ...
        getZhangFuKongJianResult(){
            ...
            if(this.activeName2 == "third"){
                // let path = "/ydhxgtest/SelectCondition/zhangfukongjian/"
                // ydc.sync().ref(path).orderByKey().get(d=>{
                //     if(d.success){
                //         zhixingList = d.nodeContent.list.replace(/\'/g, "");
                //         page2 = this.page2;
                ...
                //         contain_ST_tszb = d.nodeContent.contain_ST_tszb;
                //         // alert(zhixingList)
                //             api.getZhangFuKongJianResult(page2,size2,satisfaction_mode_jbm,contain_ST_jbm,satisfaction_mode_tszb,contain_ST_tszb,zhixingList).then((res)=>{
                //             // alert(JSON.stringify(res))
                //             this.zhangfuList = res.data.content
                ...
                if(this.statu==0){
                    ...
                    // this.sign = '0'
                    var iden = '0'//查全部
                    api.getZhangFuKongJianResult(page2,size2,satisfaction_mode_jbm,contain_ST_jbm,satisfaction_mode_tszb,contain_ST_tszb,iden,zhixingList).then((res)=>{
                        this.zhangfuList = res.data.content
                        this.total2 = res.data.totalElements
                    });
                }else{
          ...
          for(var i=0;i<this.seleDataList.length;i++){
              ...
              if(this.seleDataList[i].child_name == '净利润'){
                ...
                if(this.seleDataList[i].calculation_symbol=='大于'){
                    ...
                    // zhixing.net_profit_left = this.seleDataList[i].fill_data_left
                    // zhixing.net_profit_right = this.seleDataList[i].fill_data_right
                }
                  zhixingList.push(zhixing)
              }
