...
<!-- 
		...
		<el-table :data="boutiqueCourseTables" highlight-current-row v-loading="loading"  @selection-change="selsChange"  style="width: 100%;">
			...
			<el-table-column prop="setName" label="所属套系"  width="300">
			</el-table-column>
		...
		<el-dialog title="添加" :visible.sync="editclass"  :close-on-click-modal="false" width="50%" center>
			<el-form :model="editruleForm" :rules="editrules" ref="editruleForm" label-width="100px" >
				<el-input v-if="false" v-model="editruleForm.start_course_id"  style="width:120px;"   ></el-input>
				<el-input v-if="false" v-model="editruleForm.video_length"  style="width:120px;"   ></el-input>
                <el-input v-if="false" v-model="editruleForm.set_id"  style="width:120px;"   ></el-input>



             <el-form-item label="选择套系" prop="set_id" >
                <el-select  v-model="editruleForm.set_id"  
                           @change="selectSet(editruleForm.set_id,editruleForm.start_course_id)" 
...
<script>
    ...
    import {selectSetForPeriod,teamStartPageList,teamStarSave,teamStarDel,startCoursebatchViewAdd,teamSetPageList} from "../../api/ydApi.js";
    export default {
        data() {
        ...
        methods: {
           ...
           async selectSet(a,b){
            ...
            selectSetForPeriod(para).then(res => {
         ...
         /*       let _this = this;
           ...
           async selectColumn(a,b){
            ...
            async    batchLikeSubmit(a,b){
                ...
                for ( var i=0;i<this.sels.length;i++)
                {
                    ...
                    if(dataArray == ""){
                        dataArray += this.sels[i].start_course_id
                    }else{
                        dataArray += ","+this.sels[i].start_course_id
                    }
                ...
                console.log(para)
                     ...
                     startCoursebatchViewAdd(para).then((res) => {
                            ...
                            /*   this.$message({
                                ...
                                var para = {
                                    ...
                                    orderBy:"a.start_course_id DESC ",
                                    team_id:this.team_id
                                };
           ...
           async batchShareSubmit(a,b){
            ...
            handleDel: function(index, row) {
                ...
                this.$confirm("   您确定删除该记录吗？删除后前台将不再显示，该记录所有的关联数据将同时被删除", "提示", {
                    ...
                    .then(async () => {
                        ...
                        console.log(row);
                        var pro = {
                            start_course_id:row.start_course_id,
                            team_id:this.team_id
            ...
            async boutiqueCoursePage(keyword) {
                   ...
                   teamStartPageList(keyword).then(res => {
