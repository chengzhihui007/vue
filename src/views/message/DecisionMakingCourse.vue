<template>
    <div class="content">
        <div class="chat-wrap">
            <div class="chat-nav" >
                <a href="javascript:void(0)" :class="qx == 3 ? 'act' : ''" @click="navClick(3)">多空决策专属课</a>
                <a href="javascript:void(0)" :class="qx == 4 ? 'act' : ''" @click="navClick(4)">风口决策专属课</a>
                <a href="javascript:void(0)" :class="qx == 5 ? 'act' : ''" @click="navClick(5)">主力决策专属课</a>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            getHistoryByDays(days){
                // 生产环境节点
                let path = "/ydhxg/ZhuanJiaFenXi/ZhiBoKeTangAsk/JueCeZhuanShuKe/";

                // 测试环境节点
                // let path = "/ydhxgtest/ZhuanJiaFenXi/ZhiBoKeTangAsk/JueCeZhuanShuKe/";
                //取消订阅
                this.unsubscribeData(path+"3/"+new Date().format('yyyyMMdd'))
