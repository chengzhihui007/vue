    ...
    export default {
        ...
        methods: {
            ...
            getHistoryByDays(days){
                // 生产环境节点
                let path="/ydhxg/ZhuanJiaFenXi/ZhiBoKeTangAsk/ShiZhanJiePanKe/";

                // 测试环境节点
                // let path="/ydhxgtest/ZhuanJiaFenXi/ZhiBoKeTangAsk/ShiZhanJiePanKe/";
                //取消订阅
                this.unsubscribeData(path+new Date().format('yyyyMMdd'))
                this.dataArr=[]
