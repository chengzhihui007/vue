<template>
    <section>
        ...
        <el-table  ref="multipleTable" :data="datas" highlight-current-row v-loading="listLoading"   @selection-change="selsChange"  style="width: 100%;">
            ...
            <el-table-column prop="teacherName" label="老师" min-width="100"></el-table-column>
        ...
        <el-dialog :title=dialogTitle  :visible.sync="FormVisible"  v-loading="editLoading" :close-on-click-modal="false" v-on:close="clearEdit" width="50%">
            <el-form :model="addForm" label-width="110px"  :rules="editFormRules" ref="addForm">
                ...
                <el-form-item label="视频类型：" prop="type">
                    ...
                    <el-select label="视频类型"  v-model="type"  placeholder="请选择视频类型">
            ...
            return {
               ...
               editLoading: false,
                ...
                editFormRules: {
                    ...
                    playAddress:[
                        { required: true, message: "请输入课程播放地址", trigger: "blur" },
                    ],
/*                    pdf:[
                ...
                this.$refs.addForm.validate(async (valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(async () => {
                            ...
                            this.addForm.teacherName = this.teachername;
                            ...
                            this.addForm.teacher=this.teacherid;
                            this.addForm.teacherId = this.teacherid;
